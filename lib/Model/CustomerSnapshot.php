...
/**
 * CustomerSnapshot Class Doc Comment
 *
 * @category Class
 ...
 */
class CustomerSnapshot implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CustomerSnapshot';
    ...
    public const DOCUMENT_PDF_TYPE_ZUGFERD2_4_EN16931 = 'zugferd2_4_en16931';
    public const DOCUMENT_PDF_TYPE_ZUGFERD2_4_EXTENDED = 'zugferd2_4_extended';
    ...
    public function getDocumentPdfTypeAllowableValues()
    {
        return [
            ...
            self::DOCUMENT_PDF_TYPE_ZUGFERD2_4_EN16931,
            self::DOCUMENT_PDF_TYPE_ZUGFERD2_4_EXTENDED,
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['cash_allowance']) && ($this->container['cash_allowance'] > 100)) {
            $invalidProperties[] = "invalid value for 'cash_allowance', must be smaller than or equal to 100.";
        }
    ...
    public function setCashAllowance($cash_allowance)
    {
        ...
        if (!is_null($cash_allowance) && ($cash_allowance > 100)) {
            throw new \InvalidArgumentException('invalid value for $cash_allowance when calling CustomerSnapshot., must be smaller than or equal to 100.');
        }
        if (!is_null($cash_allowance) && ($cash_allowance < 0)) {
            throw new \InvalidArgumentException('invalid value for $cash_allowance when calling CustomerSnapshot., must be bigger than or equal to 0.');
        }
     ...
     * Sets number
     *
     * @param string|null $number Automatically generated if empty/omitted and when no type in query is provided or the type 'CUSTOMER', 'CUSTOMER,SUPPLIER'
     *
     * @return self
     */
     ...
     *
     * @param string|null $supplier_number Automatically generated if the type SUPPLIER or 'CUSTOMER,SUPPLIER' is provided as query parameter and the field supplier_number is empty/omitted.
     *
     * @return self
     */
