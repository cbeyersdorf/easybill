...
# **positionsGet**
> \cbeyersdorf\easybill\Model\Positions positionsGet($limit, $page, $type, $number)
...
# **positionsIdGet**
> \cbeyersdorf\easybill\Model\Position positionsIdGet($id)
...
# **positionsIdPut**
> \cbeyersdorf\easybill\Model\Position positionsIdPut($id, $body)
...
# **positionsPost**
> \cbeyersdorf\easybill\Model\Position positionsPost($body)
