...
class Document implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'amount' => 'int',
        'amount_net' => 'int',
        'anonymize_due_date' => '\DateTime',
        'anonymize_status' => 'string',
    ...
    protected static array $openAPINullables = [
        ...
        'amount' => false,
        'amount_net' => false,
        'anonymize_due_date' => true,
        'anonymize_status' => false,
        'anonymized_at' => true,
    ...
    protected static $setters = [
        ...
        'anonymize_due_date' => 'setAnonymizeDueDate',
        'anonymize_status' => 'setAnonymizeStatus',
        'anonymized_at' => 'setAnonymizedAt',
    ...
    protected static $getters = [
        ...
        'anonymize_due_date' => 'getAnonymizeDueDate',
        'anonymize_status' => 'getAnonymizeStatus',
        'anonymized_at' => 'getAnonymizedAt',
    ...
    public const ANONYMIZE_STATUS_NOT_ANONYMIZED = 'NOT_ANONYMIZED';
    public const ANONYMIZE_STATUS_ANONYMIZED = 'ANONYMIZED';
     ...
     * @return string[]
     */
    public function getAnonymizeStatusAllowableValues()
    {
        return [
            self::ANONYMIZE_STATUS_NOT_ANONYMIZED,
            self::ANONYMIZE_STATUS_ANONYMIZED,
        ];
    }
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('anonymize_due_date', $data ?? [], null);
        $this->setIfExists('anonymize_status', $data ?? [], 'NOT_ANONYMIZED');
        $this->setIfExists('anonymized_at', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getAnonymizeStatusAllowableValues();
        if (!is_null($this->container['anonymize_status']) && !in_array($this->container['anonymize_status'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'anonymize_status', must be one of '%s'",
                $this->container['anonymize_status'],
    ...
    /**
     * Gets anonymize_due_date
     *
     * @return \DateTime|null
     */
    public function getAnonymizeDueDate()
    {
        return $this->container['anonymize_due_date'];
    }

    /**
     * Sets anonymize_due_date
     *
     * @param \DateTime|null $anonymize_due_date A date which signals when to anonymize the document. Must be in the future. Turns into a read only field if the document is anonymized
     *
     * @return self
     */
    public function setAnonymizeDueDate($anonymize_due_date)
    {
        if (is_null($anonymize_due_date)) {
            array_push($this->openAPINullablesSetToNull, 'anonymize_due_date');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('anonymize_due_date', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['anonymize_due_date'] = $anonymize_due_date;

        return $this;
    }

    /**
     * Gets anonymize_status
     *
     * @return string|null
     */
    public function getAnonymizeStatus()
    {
        return $this->container['anonymize_status'];
    }

    /**
     * Sets anonymize_status
     *
     * @param string|null $anonymize_status This field signals if the document was anonymized
     *
     * @return self
     */
    public function setAnonymizeStatus($anonymize_status)
    {
        if (is_null($anonymize_status)) {
            throw new \InvalidArgumentException('non-nullable anonymize_status cannot be null');
        }
        $allowedValues = $this->getAnonymizeStatusAllowableValues();
        if (!in_array($anonymize_status, $allowedValues, true)) {
        ...
        $this->container['anonymize_status'] = $anonymize_status;
    ...
    {
        return $this->container['anonymized_at'];
    }

    /**
     * Sets anonymized_at
     *
     * @param string|null $anonymized_at anonymized_at
     *
     * @return self
     */
    public function setAnonymizedAt($anonymized_at)
    {
        if (is_null($anonymized_at)) {
            array_push($this->openAPINullablesSetToNull, 'anonymized_at');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('anonymized_at', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['anonymized_at'] = $anonymized_at;
     ...
     * Sets cash_allowance
     *
     * @param float|null $cash_allowance Cash allowance percentage. If not provided, inherits from customer when available.
     *
     * @return self
     */
     ...
     *
     * @param int|null $cash_allowance_days Days for cash allowance. If not provided, inherits from customer when available.
     *
     * @return self
     */
     ...
     * Sets due_in_days
     *
     * @param int|null $due_in_days due date in days. If not provided, inherits from customer when available
     *
     * @return self
     */
