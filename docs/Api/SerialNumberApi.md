...
# **serialNumbersGet**
> \cbeyersdorf\easybill\Model\SerialNumbers serialNumbersGet($limit, $page, $position_id, $document_id, $in_use)
...
# **serialNumbersIdGet**
> \cbeyersdorf\easybill\Model\SerialNumber serialNumbersIdGet($id)
...
# **serialNumbersPost**
> \cbeyersdorf\easybill\Model\SerialNumber serialNumbersPost($body)
