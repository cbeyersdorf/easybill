...
class SEPAPayment implements ModelInterface, ArrayAccess
{
    ...
    {
        if (!is_null($debitor_address_line_1) && (mb_strlen($debitor_address_line_1) > 70)) {
    ...
    {
        if (!is_null($debitor_address_line2) && (mb_strlen($debitor_address_line2) > 70)) {
    ...
    {
        if (!is_null($debitor_country) && (mb_strlen($debitor_country) > 2)) {
