...
class SEPAPayment implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['mandate_id']) && (mb_strlen($this->container['mandate_id']) > 34)) {
     ...
     * Sets debitor_bic
     *
     * @param string $debitor_bic debitor_bic
     *
     * @return $this
     */
     ...
     * Sets debitor_iban
     *
     * @param string $debitor_iban debitor_iban
     *
     * @return $this
     */
     ...
     * Sets debitor_name
     *
     * @param string $debitor_name debitor_name
     *
     * @return $this
     */
     ...
     * Sets export_at
     *
     * @param string $export_at export_at
     *
     * @return $this
     */
     ...
     *
     * @param string $local_instrument local_instrument
     *
     * @return $this
     */
    ...
    {
        $allowedValues = $this->getLocalInstrumentAllowableValues();
        if (!is_null($local_instrument) && !in_array($local_instrument, $allowedValues, true)) {
    ...
    {
        if (!is_null($mandate_id) && (mb_strlen($mandate_id) > 34)) {
