...
# **customersIdGet**
> \cbeyersdorf\easybill\Model\Customer customersIdGet($id)
...
# **customersIdPut**
> \cbeyersdorf\easybill\Model\Customer customersIdPut($id, $body)
...
# **customersPost**
> \cbeyersdorf\easybill\Model\Customer customersPost($body)
