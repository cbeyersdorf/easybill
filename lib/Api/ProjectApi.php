...
class ProjectApi
{
     ...
     */
    public function projectsGet($limit = null, $page = null, $customer_id = null, $status = null)
    {
        list($response) = $this->projectsGetWithHttpInfo($limit, $page, $customer_id, $status);
        return $response;
    }
     ...
     */
    public function projectsGetWithHttpInfo($limit = null, $page = null, $customer_id = null, $status = null)
    {
        $returnType = '\cbeyersdorf\easybill\Model\Projects';
        $request = $this->projectsGetRequest($limit, $page, $customer_id, $status);
     ...
     */
    public function projectsGetAsync($limit = null, $page = null, $customer_id = null, $status = null)
    {
        return $this->projectsGetAsyncWithHttpInfo($limit, $page, $customer_id, $status)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function projectsGetAsyncWithHttpInfo($limit = null, $page = null, $customer_id = null, $status = null)
    {
        $returnType = '\cbeyersdorf\easybill\Model\Projects';
        $request = $this->projectsGetRequest($limit, $page, $customer_id, $status);
     ...
     */
    protected function projectsGetRequest($limit = null, $page = null, $customer_id = null, $status = null)
    {
    ...
    {
        $returnType = '\cbeyersdorf\easybill\Model\Project';
        $request = $this->projectsIdPutRequest($id, $body);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function projectsIdPutAsync($id, $body)
    {
        return $this->projectsIdPutAsyncWithHttpInfo($id, $body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function projectsIdPutAsyncWithHttpInfo($id, $body)
    {
        $returnType = '\cbeyersdorf\easybill\Model\Project';
        $request = $this->projectsIdPutRequest($id, $body);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function projectsIdPutRequest($id, $body)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function projectsPostAsync($body)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function projectsPostAsyncWithHttpInfo($body)
    {
        $returnType = '\cbeyersdorf\easybill\Model\Project';
        $request = $this->projectsPostRequest($body);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function projectsPostRequest($body)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
