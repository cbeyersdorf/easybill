 ...
 */
class PDFTemplate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PDFTemplate';
    ...
    protected static $openAPITypes = [
        ...
        'settings' => '\cbeyersdorf\easybill\Model\PDFTemplateSettings'
    ];
    ...
    {
        $this->setIfExists('id', $data ?? [], 'INVOICE-DE');
        $this->setIfExists('name', $data ?? [], 'Default template');
        $this->setIfExists('pdf_template', $data ?? [], 'DE');
    ...
    */
     ...
     * Sets pdf_template
     *
     * @param string|null $pdf_template pdf_template
     *
     * @return self
     */
     ...
     * Gets settings
     *
     * @return \cbeyersdorf\easybill\Model\PDFTemplateSettings|null
     */
     ...
     * Sets settings
     *
     * @param \cbeyersdorf\easybill\Model\PDFTemplateSettings|null $settings settings
     *
     * @return self
     */
