    ...
    */
    ...
    public function setCashAllowance($cash_allowance)
    {
        ...
        if (!is_null($cash_allowance) && ($cash_allowance > 1E+2)) {
            throw new \InvalidArgumentException('invalid value for $cash_allowance when calling CustomerSnapshot., must be smaller than or equal to 1E+2.');
        }
     ...
     * Sets sepa_agreement
     *
     * @param string|null $sepa_agreement BASIC = SEPA-Basislastschrift, COR1 = SEPA-Basislastschrift COR1, COMPANY = SEPA-Firmenlastschrift, NULL = Noch kein Mandat erteilt
     *
     * @return self
     */
