...
class DocumentApi
{
    ...
    protected function documentsGetRequest($limit = null, $page = null, $type = null, $is_draft = null, $is_archive = null, $customer_id = null, $project_id = null, $ref_id = null, $document_date = null, $paid_at = null, $title = null, $number = null, $cancel_id = null, $fulfillment_country = null, $vat_country = null, $shipping_country = null, $status = null)
    {
        ...
        // query params
        if ($ref_id !== null) {
            $queryParams['ref_id'] = ObjectSerializer::toQueryValue($ref_id);
        }
        // query params
     ...
     */
    public function documentsIdCancelPost($id, $use_text_from_template = 'false')
    {
        list($response) = $this->documentsIdCancelPostWithHttpInfo($id, $use_text_from_template);
        return $response;
    }
     ...
     */
    public function documentsIdCancelPostWithHttpInfo($id, $use_text_from_template = 'false')
    {
        $returnType = '\cbeyersdorf\easybill\Model\Document';
        $request = $this->documentsIdCancelPostRequest($id, $use_text_from_template);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function documentsIdCancelPostAsync($id, $use_text_from_template = 'false')
    {
        return $this->documentsIdCancelPostAsyncWithHttpInfo($id, $use_text_from_template)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function documentsIdCancelPostAsyncWithHttpInfo($id, $use_text_from_template = 'false')
    {
        $returnType = '\cbeyersdorf\easybill\Model\Document';
        $request = $this->documentsIdCancelPostRequest($id, $use_text_from_template);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function documentsIdCancelPostRequest($id, $use_text_from_template = 'false')
    {
        ...
        // query params
        if ($use_text_from_template !== null) {
            $queryParams['use_text_from_template'] = ObjectSerializer::toQueryValue($use_text_from_template);
        }
