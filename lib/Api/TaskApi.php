...
class TaskApi
{
    ...
    {
        $returnType = '\cbeyersdorf\easybill\Model\Task';
        $request = $this->tasksIdPutRequest($id, $body);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function tasksIdPutAsync($id, $body)
    {
        return $this->tasksIdPutAsyncWithHttpInfo($id, $body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function tasksIdPutAsyncWithHttpInfo($id, $body)
    {
        $returnType = '\cbeyersdorf\easybill\Model\Task';
        $request = $this->tasksIdPutRequest($id, $body);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function tasksIdPutRequest($id, $body)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
