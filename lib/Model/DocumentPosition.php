...
class DocumentPosition implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param float|null $single_price_net Price in cents, despite being of type float (e.g. 150 = 1.50€, but also 150.0 = 1.50€)
     *
     * @return self
     */
     ...
     *
     * @param float|null $single_price_gross Price in cents, despite being of type float (e.g. 150 = 1.50€, but also 150.0 = 1.50€)
     *
     * @return self
     */
     ...
     *
     * @param float|null $total_price_net Price in cents, despite being of type float (e.g. 150 = 1.50€, but also 150.0 = 1.50€)
     *
     * @return self
     */
     ...
     *
     * @param float|null $total_price_gross Price in cents, despite being of type float (e.g. 150 = 1.50€, but also 150.0 = 1.50€)
     *
     * @return self
     */
     ...
     * Sets cost_price_net
     *
     * @param float|null $cost_price_net Price in cents, despite being of type float (e.g. 150 = 1.50€, but also 150.0 = 1.50€)
     *
     * @return self
     */
     ...
     *
     * @param float|null $cost_price_total Price in cents, despite being of type float (e.g. 150 = 1.50€, but also 150.0 = 1.50€)
     *
     * @return self
     */
