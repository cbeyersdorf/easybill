...
**anonymize_due_date** | **\DateTime** | A date which signals when to anonymize the document. Must be in the future. Turns into a read only field if the document is anonymized | [optional]
**anonymize_status** | **string** | This field signals if the document was anonymized | [optional] [readonly] [default to 'NOT_ANONYMIZED']
**anonymized_at** | **string** |  | [optional] [readonly]
