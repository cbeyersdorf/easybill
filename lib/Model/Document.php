...
class Document implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('is_cold', $data ?? [], false);
        $this->setIfExists('is_oss', $data ?? [], false);
        $this->setIfExists('coldstorage_due_date', $data ?? [], null);
    ...
    */
     ...
     * Sets is_cold
     *
     * @param bool|null $is_cold Indicates if a document is in the long term archive
     *
     * @return self
     */
    ...
    {
        if (is_null($is_cold)) {
            throw new \InvalidArgumentException('non-nullable is_cold cannot be null');
        }
     ...
     *
     * @param \DateTime|null $coldstorage_due_date Signals when the document should be moved to the long term archive
     *
     * @return self
     */
    public function setColdstorageDueDate($coldstorage_due_date)
    {
        if (is_null($coldstorage_due_date)) {
            array_push($this->openAPINullablesSetToNull, 'coldstorage_due_date');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('coldstorage_due_date', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
