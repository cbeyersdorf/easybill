...
class SerialNumberApi
{
     ...
     * @param  string|null $position_id Filter serial numbers by position id. (optional)
     * @param  string|null $document_id Filter serial numbers by document id. (optional)
     * @param  bool|null $in_use Filter serial numbers by usage. (optional)
     ...
     *
     * @param  \cbeyersdorf\easybill\Model\SerialNumber|null $body body (optional)
     ...
     * Create s serial number for a position
     *
     * @param  \cbeyersdorf\easybill\Model\SerialNumber|null $body (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['serialNumbersPost'] to see the possible values for this operation
     *
     * @throws \cbeyersdorf\easybill\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
