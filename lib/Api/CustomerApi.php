...
class CustomerApi
{
     ...
     * @param  string|null $group_id Filter customers by group_id. You can add multiple group ids separate by comma like id,id,id. (optional)
     * @param  string|null $additional_group_id Filter customers by additional_group_id. You can add multiple group ids separate by comma like id,id,id. (optional)
     * @param  string|null $number Filter customers by number. You can add multiple numbers separate by comma like no,no,no. (optional)
     * @param  string|null $country Filter customers by country. You can add multiple countries separate by comma like DE,PL,FR. (optional)
     * @param  string|null $zip_code Filter customers by zip_code. You can add multiple zip codes separate by comma like zip,zip,zip. (optional)
     * @param  string|null $emails Filter customers by emails. You can add multiple emails separate by comma like mail,mail,mail. (optional)
     * @param  string|null $first_name Filter customers by first_name. You can add multiple names separate by comma like name,name,name. (optional)
     * @param  string|null $last_name Filter customers by first_name. You can add multiple names separate by comma like name,name,name. (optional)
     * @param  string|null $company_name Filter customers by first_name. You can add multiple names separate by comma like name,name,name. (optional)
     * @param  string|null $created_at Filter customers by created_at. You can filter one date with created_at&#x3D;2014-12-10 or between like 2015-01-01,2015-12-31. (optional)
     ...
     * @param  string|null $type Controls the type of the customer. If provided and the field \&quot;number\&quot; or \&quot;supplier_number\&quot; is empty or omitted, the type will force the generation of the relevant number if applicable. I. e. omitting \&quot;supplier_number\&quot; but providing the query parameter \&quot;SUPPLIER\&quot; will generate a \&quot;supplier_number\&quot;. (optional, default to 'CUSTOMER')
     ...
     * @return \cbeyersdorf\easybill\Model\Customer
     */
    public function customersIdPut($id, $body, $type = 'CUSTOMER', string $contentType = self::contentTypes['customersIdPut'][0])
    {
        list($response) = $this->customersIdPutWithHttpInfo($id, $body, $type, $contentType);
        return $response;
    }
     ...
     * @return array of \cbeyersdorf\easybill\Model\Customer, HTTP status code, HTTP response headers (array of strings)
     */
    public function customersIdPutWithHttpInfo($id, $body, $type = 'CUSTOMER', string $contentType = self::contentTypes['customersIdPut'][0])
    {
        $request = $this->customersIdPutRequest($id, $body, $type, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function customersIdPutAsync($id, $body, $type = 'CUSTOMER', string $contentType = self::contentTypes['customersIdPut'][0])
    {
        return $this->customersIdPutAsyncWithHttpInfo($id, $body, $type, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function customersIdPutAsyncWithHttpInfo($id, $body, $type = 'CUSTOMER', string $contentType = self::contentTypes['customersIdPut'][0])
    {
        $returnType = '\cbeyersdorf\easybill\Model\Customer';
        $request = $this->customersIdPutRequest($id, $body, $type, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function customersIdPutRequest($id, $body, $type = 'CUSTOMER', string $contentType = self::contentTypes['customersIdPut'][0])
    {
     ...
     * @return \cbeyersdorf\easybill\Model\Customer
     */
    public function customersPost($body, $type = 'CUSTOMER', string $contentType = self::contentTypes['customersPost'][0])
    {
        list($response) = $this->customersPostWithHttpInfo($body, $type, $contentType);
        return $response;
    }
     ...
     * @return array of \cbeyersdorf\easybill\Model\Customer, HTTP status code, HTTP response headers (array of strings)
     */
    public function customersPostWithHttpInfo($body, $type = 'CUSTOMER', string $contentType = self::contentTypes['customersPost'][0])
    {
        $request = $this->customersPostRequest($body, $type, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function customersPostAsync($body, $type = 'CUSTOMER', string $contentType = self::contentTypes['customersPost'][0])
    {
        return $this->customersPostAsyncWithHttpInfo($body, $type, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function customersPostAsyncWithHttpInfo($body, $type = 'CUSTOMER', string $contentType = self::contentTypes['customersPost'][0])
    {
        $returnType = '\cbeyersdorf\easybill\Model\Customer';
        $request = $this->customersPostRequest($body, $type, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function customersPostRequest($body, $type = 'CUSTOMER', string $contentType = self::contentTypes['customersPost'][0])
    {
