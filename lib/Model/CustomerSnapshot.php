 ...
 *
 * @category Class
 * @description A snapshot of the customer model which belongs to a document. This model is readonly and the state is final after finalization of the document. It&#39;s is identical to the state of the customer model at the time of finalization
 * @package  cbeyersdorf\easybill
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CustomerSnapshot implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CustomerSnapshot';
     ...
     * Sets grace_period
     *
     * @param int $grace_period Days for payment.
     *
     * @return $this
     */
