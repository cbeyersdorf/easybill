...
class SEPAPayment implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['debitor_iban'] === null && !$this->isNullableSetToNull('debitor_iban')) {
            $invalidProperties[] = "'debitor_iban' can't be null";
        }
        if ($this->container['debitor_name'] === null && !$this->isNullableSetToNull('debitor_name')) {
     ...
     * Sets debitor_iban
     *
     * @param string|null $debitor_iban Mandatory if type is DEBIT. If type is CREDIT, this field is overwritten with the selected bank account data on export.
     *
     * @return self
     */
     ...
     * Sets debitor_name
     *
     * @param string|null $debitor_name Mandatory if type is DEBIT. If type is CREDIT, this field is overwritten with the selected bank account data on export.
     *
     * @return self
     */
