...
class PostBox implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const DOCUMENT_FILE_TYPE_ZUGFERD2_2 = 'zugferd2_2';
    public const DOCUMENT_FILE_TYPE_ZUGFERD2_4_EN16931 = 'zugferd2_4_en16931';
    public const DOCUMENT_FILE_TYPE_ZUGFERD2_4_EXTENDED = 'zugferd2_4_extended';
    public const DOCUMENT_FILE_TYPE_XRECHNUNG = 'xrechnung';
    public const DOCUMENT_FILE_TYPE_XRECHNUNG_XML = 'xrechnung_xml';
    public const POST_SEND_TYPE_POST_SEND_TYPE_STANDARD = 'post_send_type_standard';
    public const POST_SEND_TYPE_POST_SEND_TYPE_REGISTERED = 'post_send_type_registered';
    public const POST_SEND_TYPE_POST_SEND_TYPE_REGISTERED_AND_PERSONAL = 'post_send_type_registered_and_personal';
    public const POST_SEND_TYPE_POST_SEND_TYPE_REGISTERED_AND_RECEIPT = 'post_send_type_registered_and_receipt';
    public const POST_SEND_TYPE_POST_SEND_TYPE_REGISTERED_THROWIN = 'post_send_type_registered_throwin';
    public const POST_SEND_TYPE_POST_SEND_TYPE_PRIO = 'post_send_type_prio';
    ...
    public function getDocumentFileTypeAllowableValues()
    {
        return [
            ...
            self::DOCUMENT_FILE_TYPE_ZUGFERD2_2,
            self::DOCUMENT_FILE_TYPE_ZUGFERD2_4_EN16931,
            self::DOCUMENT_FILE_TYPE_ZUGFERD2_4_EXTENDED,
    ...
    {
        return [
            self::POST_SEND_TYPE_POST_SEND_TYPE_STANDARD,
            self::POST_SEND_TYPE_POST_SEND_TYPE_REGISTERED,
            self::POST_SEND_TYPE_POST_SEND_TYPE_REGISTERED_AND_PERSONAL,
            self::POST_SEND_TYPE_POST_SEND_TYPE_REGISTERED_AND_RECEIPT,
            self::POST_SEND_TYPE_POST_SEND_TYPE_REGISTERED_THROWIN,
            self::POST_SEND_TYPE_POST_SEND_TYPE_PRIO,
        ];
    }
