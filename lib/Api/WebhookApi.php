...
class WebhookApi
{
     ...
     * @return \cbeyersdorf\easybill\Model\WebHooks
     */
    public function webhooksGet($limit = null, $page = null, string $contentType = self::contentTypes['webhooksGet'][0])
    {
        list($response) = $this->webhooksGetWithHttpInfo($limit, $page, $contentType);
        return $response;
    }
     ...
     * @throws \cbeyersdorf\easybill\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \cbeyersdorf\easybill\Model\WebHooks, HTTP status code, HTTP response headers (array of strings)
     */
    public function webhooksGetWithHttpInfo($limit = null, $page = null, string $contentType = self::contentTypes['webhooksGet'][0])
    {
        $request = $this->webhooksGetRequest($limit, $page, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\cbeyersdorf\easybill\Model\WebHooks' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\cbeyersdorf\easybill\Model\WebHooks' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\cbeyersdorf\easybill\Model\WebHooks', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\cbeyersdorf\easybill\Model\WebHooks';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\cbeyersdorf\easybill\Model\WebHooks',
     ...
     */
    public function webhooksGetAsync($limit = null, $page = null, string $contentType = self::contentTypes['webhooksGet'][0])
    {
        return $this->webhooksGetAsyncWithHttpInfo($limit, $page, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function webhooksGetAsyncWithHttpInfo($limit = null, $page = null, string $contentType = self::contentTypes['webhooksGet'][0])
    {
        $returnType = '\cbeyersdorf\easybill\Model\WebHooks';
        $request = $this->webhooksGetRequest($limit, $page, $contentType);
     ...
     */
    public function webhooksGetRequest($limit = null, $page = null, string $contentType = self::contentTypes['webhooksGet'][0])
    {

        if ($limit !== null && $limit > 1000) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling WebhookApi.webhooksGet, must be smaller than or equal to 1000.');
        }
        if ($limit !== null && $limit < 1) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling WebhookApi.webhooksGet, must be bigger than or equal to 1.');
        }
        
        if ($page !== null && $page < 1) {
            throw new \InvalidArgumentException('invalid value for "$page" when calling WebhookApi.webhooksGet, must be bigger than or equal to 1.');
        }
     ...
     * Delete WebHook
     *
     * @param  int $id ID of WebHook (required)
     ...
     * @throws \cbeyersdorf\easybill\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \cbeyersdorf\easybill\Model\WebHook
     */
     ...
     * @throws \cbeyersdorf\easybill\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \cbeyersdorf\easybill\Model\WebHook, HTTP status code, HTTP response headers (array of strings)
     */
    public function webhooksIdGetWithHttpInfo($id, string $contentType = self::contentTypes['webhooksIdGet'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\cbeyersdorf\easybill\Model\WebHook' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\cbeyersdorf\easybill\Model\WebHook' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\cbeyersdorf\easybill\Model\WebHook', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\cbeyersdorf\easybill\Model\WebHook';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\cbeyersdorf\easybill\Model\WebHook',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  int $id ID of WebHook (required)
     * @param  \cbeyersdorf\easybill\Model\WebHook $body body (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['webhooksIdPut'] to see the possible values for this operation
     *
     * @throws \cbeyersdorf\easybill\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \cbeyersdorf\easybill\Model\WebHook
     */
    public function webhooksIdPut($id, $body, string $contentType = self::contentTypes['webhooksIdPut'][0])
    {
        list($response) = $this->webhooksIdPutWithHttpInfo($id, $body, $contentType);
        return $response;
    }
     ...
     *
     * @param  int $id ID of WebHook (required)
     * @param  \cbeyersdorf\easybill\Model\WebHook $body (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['webhooksIdPut'] to see the possible values for this operation
     *
     * @throws \cbeyersdorf\easybill\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \cbeyersdorf\easybill\Model\WebHook, HTTP status code, HTTP response headers (array of strings)
     */
    public function webhooksIdPutWithHttpInfo($id, $body, string $contentType = self::contentTypes['webhooksIdPut'][0])
    {
        $request = $this->webhooksIdPutRequest($id, $body, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function webhooksIdPutAsync($id, $body, string $contentType = self::contentTypes['webhooksIdPut'][0])
    {
        return $this->webhooksIdPutAsyncWithHttpInfo($id, $body, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function webhooksIdPutAsyncWithHttpInfo($id, $body, string $contentType = self::contentTypes['webhooksIdPut'][0])
    {
        $returnType = '\cbeyersdorf\easybill\Model\WebHook';
        $request = $this->webhooksIdPutRequest($id, $body, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function webhooksIdPutRequest($id, $body, string $contentType = self::contentTypes['webhooksIdPut'][0])
    {
