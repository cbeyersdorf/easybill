...
class SerialNumberApi
{
     ...
     */
    public function serialNumbersGet($limit = null, $page = null, $position_id = null, $document_id = null, $in_use = null)
    {
        list($response) = $this->serialNumbersGetWithHttpInfo($limit, $page, $position_id, $document_id, $in_use);
        return $response;
    }
     ...
     */
    public function serialNumbersGetWithHttpInfo($limit = null, $page = null, $position_id = null, $document_id = null, $in_use = null)
    {
        $returnType = '\cbeyersdorf\easybill\Model\SerialNumbers';
        $request = $this->serialNumbersGetRequest($limit, $page, $position_id, $document_id, $in_use);
     ...
     */
    public function serialNumbersGetAsync($limit = null, $page = null, $position_id = null, $document_id = null, $in_use = null)
    {
        return $this->serialNumbersGetAsyncWithHttpInfo($limit, $page, $position_id, $document_id, $in_use)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function serialNumbersGetAsyncWithHttpInfo($limit = null, $page = null, $position_id = null, $document_id = null, $in_use = null)
    {
        $returnType = '\cbeyersdorf\easybill\Model\SerialNumbers';
        $request = $this->serialNumbersGetRequest($limit, $page, $position_id, $document_id, $in_use);
     ...
     */
    protected function serialNumbersGetRequest($limit = null, $page = null, $position_id = null, $document_id = null, $in_use = null)
    {
        ...
        // query params
        if ($in_use !== null) {
            $queryParams['in_use'] = ObjectSerializer::toQueryValue($in_use);
        }
     ...
     * @return void
     */
    public function serialNumbersIdDelete($id)
    {
        $this->serialNumbersIdDeleteWithHttpInfo($id);
    }
     ...
     */
    public function serialNumbersIdDeleteWithHttpInfo($id)
    {
        $returnType = '';
        $request = $this->serialNumbersIdDeleteRequest($id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function serialNumbersIdDeleteAsync($id)
    {
        return $this->serialNumbersIdDeleteAsyncWithHttpInfo($id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function serialNumbersIdDeleteAsyncWithHttpInfo($id)
    {
        $returnType = '';
        $request = $this->serialNumbersIdDeleteRequest($id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function serialNumbersIdDeleteRequest($id)
    {
     ...
     */
    public function serialNumbersIdGet($id)
    {
        list($response) = $this->serialNumbersIdGetWithHttpInfo($id);
        return $response;
    }
     ...
     */
    public function serialNumbersIdGetWithHttpInfo($id)
    {
        $returnType = '\cbeyersdorf\easybill\Model\SerialNumber';
        $request = $this->serialNumbersIdGetRequest($id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function serialNumbersIdGetAsync($id)
    {
        return $this->serialNumbersIdGetAsyncWithHttpInfo($id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function serialNumbersIdGetAsyncWithHttpInfo($id)
    {
        $returnType = '\cbeyersdorf\easybill\Model\SerialNumber';
        $request = $this->serialNumbersIdGetRequest($id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function serialNumbersIdGetRequest($id)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \cbeyersdorf\easybill\Model\SerialNumber
     */
    public function serialNumbersPost($body = null)
    {
        list($response) = $this->serialNumbersPostWithHttpInfo($body);
        return $response;
    }
     ...
     * @return array of \cbeyersdorf\easybill\Model\SerialNumber, HTTP status code, HTTP response headers (array of strings)
     */
    public function serialNumbersPostWithHttpInfo($body = null)
    {
        $returnType = '\cbeyersdorf\easybill\Model\SerialNumber';
        $request = $this->serialNumbersPostRequest($body);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function serialNumbersPostAsync($body = null)
    {
        return $this->serialNumbersPostAsyncWithHttpInfo($body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function serialNumbersPostAsyncWithHttpInfo($body = null)
    {
        $returnType = '\cbeyersdorf\easybill\Model\SerialNumber';
        $request = $this->serialNumbersPostRequest($body);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function serialNumbersPostRequest($body = null)
    {
