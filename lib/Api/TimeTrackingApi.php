...
class TimeTrackingApi
{
     ...
     */
    public function timeTrackingsGet($limit = null, $page = null, $login_id = null, $project_id = null)
    {
        list($response) = $this->timeTrackingsGetWithHttpInfo($limit, $page, $login_id, $project_id);
        return $response;
    }
     ...
     */
    public function timeTrackingsGetWithHttpInfo($limit = null, $page = null, $login_id = null, $project_id = null)
    {
        $returnType = '\cbeyersdorf\easybill\Model\TimeTrackings';
        $request = $this->timeTrackingsGetRequest($limit, $page, $login_id, $project_id);
     ...
     */
    public function timeTrackingsGetAsync($limit = null, $page = null, $login_id = null, $project_id = null)
    {
        return $this->timeTrackingsGetAsyncWithHttpInfo($limit, $page, $login_id, $project_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function timeTrackingsGetAsyncWithHttpInfo($limit = null, $page = null, $login_id = null, $project_id = null)
    {
        $returnType = '\cbeyersdorf\easybill\Model\TimeTrackings';
        $request = $this->timeTrackingsGetRequest($limit, $page, $login_id, $project_id);
     ...
     */
    protected function timeTrackingsGetRequest($limit = null, $page = null, $login_id = null, $project_id = null)
    {
        ...
        // query params
        if ($login_id !== null) {
            $queryParams['login_id'] = ObjectSerializer::toQueryValue($login_id);
        }
        // query params
        if ($project_id !== null) {
    ...
    {
        $this->timeTrackingsIdDeleteWithHttpInfo($id);
    }
    ...
    {
        $returnType = '';
        $request = $this->timeTrackingsIdDeleteRequest($id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function timeTrackingsIdDeleteAsync($id)
    {
        return $this->timeTrackingsIdDeleteAsyncWithHttpInfo($id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function timeTrackingsIdDeleteAsyncWithHttpInfo($id)
    {
        $returnType = '';
        $request = $this->timeTrackingsIdDeleteRequest($id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function timeTrackingsIdDeleteRequest($id)
    {
    ...
    public function timeTrackingsIdGetWithHttpInfo($id)
    {
        ...
        $request = $this->timeTrackingsIdGetRequest($id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function timeTrackingsIdGetAsync($id)
    {
        return $this->timeTrackingsIdGetAsyncWithHttpInfo($id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function timeTrackingsIdGetAsyncWithHttpInfo($id)
    {
        $returnType = '\cbeyersdorf\easybill\Model\TimeTracking';
        $request = $this->timeTrackingsIdGetRequest($id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function timeTrackingsIdGetRequest($id)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
    ...
    {
        $returnType = '\cbeyersdorf\easybill\Model\TimeTracking';
        $request = $this->timeTrackingsIdPutRequest($id, $body);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function timeTrackingsIdPutAsync($id, $body)
    {
        return $this->timeTrackingsIdPutAsyncWithHttpInfo($id, $body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function timeTrackingsIdPutAsyncWithHttpInfo($id, $body)
    {
        $returnType = '\cbeyersdorf\easybill\Model\TimeTracking';
        $request = $this->timeTrackingsIdPutRequest($id, $body);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function timeTrackingsIdPutRequest($id, $body)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
    ...
    {
        $returnType = '\cbeyersdorf\easybill\Model\TimeTracking';
        $request = $this->timeTrackingsPostRequest($body);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function timeTrackingsPostAsync($body)
    {
        return $this->timeTrackingsPostAsyncWithHttpInfo($body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function timeTrackingsPostAsyncWithHttpInfo($body)
    {
        $returnType = '\cbeyersdorf\easybill\Model\TimeTracking';
        $request = $this->timeTrackingsPostRequest($body);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function timeTrackingsPostRequest($body)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
